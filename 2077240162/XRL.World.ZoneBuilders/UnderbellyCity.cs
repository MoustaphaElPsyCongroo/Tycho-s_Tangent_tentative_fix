		...
		public bool BuildZone(Zone Z)
		{
			...
			for (int num49 = 0; num49 < array3.GetUpperBound(0) + 1; num49++)
			{
				for (int num50 = 0; num50 < array3.GetUpperBound(1) + 1; num50++)
				{
					...
					{
						Z.GetCell(num49 + XCorner, num50 + YCorner).AddObject("Grit Gate Metal Table");
					}
					if (array3[num49, num50] == TileType.BigChest)
					{
						Z.GetCell(num49 + XCorner, num50 + YCorner).AddObject("Tick Husk");
					}
					if (array3[num49, num50] == TileType.Creature1)
					{
						Z.GetCell(num49 + XCorner, num50 + YCorner).AddObject("DiskMerchant");
					}
					if (array3[num49, num50] == TileType.Liquid)
					{
						if (num49 == 0 || num49 >= array3.GetUpperBound(0) || num50 == 0 || num50 >= array3.GetUpperBound(1))
						{
							Z.GetCell(num49 + XCorner, num50 + YCorner).AddObject("PaintedFlowers");
						}
						else
						{
							int num51 = 0;
							...
							if (num51 == 9)
							{
								Z.GetCell(num49 + XCorner, num50 + YCorner).AddObject("ArenaFloor");
							}
							else
							{
								Z.GetCell(num49 + XCorner, num50 + YCorner).AddObject("PaintedFlowers");
					...
					{
						Z.GetCell(num49 + XCorner, num50 + YCorner).AddTableObject("Scrap 2");
					}
